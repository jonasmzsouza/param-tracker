...
(() => {
    ...
    return {
      ...
      handleDocumentClick(event) {
        ...
        if (buttonElement) {
          ...
          if (!form) return;
          const isAcceptedForm = instance.config.form.acceptFormIds.some(
  ...
  // src/utils/params.js
  function sanitizeAndMergeParams(config, baseUrl, rawLinkQuery = "", rawCurrentQuery = "") {
    try {
  ...
  function createFormHandler(instance) {
    return {
      /**
  ...
  function createLinkHandler(instance) {
    return {
      /**
  ...
  // src/domain/resolve-root-domain.js
  function resolveRootDomain(hostname = "") {
    return getDomain2(hostname) || hostname;
  }

  // src/utils/sanitize.js
  function sanitizeStringArray(arr = [], options = {}) {
  ...
  function mergeUnique(defaultArr = [], customArr = [], options = {}) {
  ...
  function buildConfig(defaults, customConfig = {}) {
    ...
    const safeCustom = typeof customConfig === "object" && customConfig !== null && !Array.isArray(customConfig) ? customConfig : {};
    const safeCustomForm = typeof safeCustom.form === "object" && safeCustom.form !== null && !Array.isArray(safeCustom.form) ? safeCustom.form : {};
    const safeCustomLink = typeof safeCustom.link === "object" && safeCustom.link !== null && !Array.isArray(safeCustom.link) ? safeCustom.link : {};
  ...
  function createLifecycle(instance) {
    return {
      /**
